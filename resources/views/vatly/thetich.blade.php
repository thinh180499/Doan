...
@section('title', 'Chuyển đổi đơn vị thể tích')

@section('content')
    <div class="row mt-4">
        <div class="col-lg-8 tinhtoan">
            <div class="card-style cardform h-100">
                <h2 class="mt-4 mb-70">Chuyển đổi đơn vị thể tích</h2>
                                    ...
                                    <div class="select-position">
                                        <select name="i">
                                            <option <?php if (isset($x) && $x == 1) {
                                                echo 'selected ';
                                            } ?>value="1">Ki-lô-mét khối (km3)</option>
                                            <option <?php if (isset($x) && $x == 2) {
                                                echo 'selected ';
                                            } ?>value="2">Héc-tô-mét khối (hm3)</option>
                                            <option <?php if (isset($x) && $x == 3) {
                                                echo 'selected ';
                                            } ?>value="3">Đề-ca-mét khối (dam3)</option>
                                            <option <?php if (isset($x) && $x == 4) {
                                                echo 'selected ';
                                            } ?>value="4">Mét khối (m3)</option>
                                            <option <?php if (isset($x) && $x == 5) {
                                                echo 'selected ';
                                            } ?>value="5">Đề-xi-mét khối (dm3)</option>
                                            <option <?php if (isset($x) && $x == 6) {
                                                echo 'selected ';
                                            } ?>value="6">Xen-ti-mét khối (cm3)</option>
                                            <option <?php if (isset($x) && $x == 7) {
                                                echo 'selected ';
                                            } ?>value="7">Mi-li-mét khối (mm3)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
