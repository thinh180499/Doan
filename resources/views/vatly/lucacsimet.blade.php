                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            <div class="col mb-4">
                                ...
                                <input type="number" id="somolchattan" name="a" placeholder="Nhập trọng lượng riêng của vật"
                            ...
                            <div class="col mb-4">
                                ...
                                <input type="number" id="thetichdungdich" name="b" placeholder="Nhập thể tích của vật"
