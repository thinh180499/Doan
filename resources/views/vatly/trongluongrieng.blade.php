    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card-style cardform">
                ...
                <form action="trongluongrieng" method="post">
                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            <div class="col mb-4">
                                ...
                                <input type="number" id="somolchattan" name="a" placeholder="Nhập trọng lượng"
                            ...
                            <div class="col mb-4">
                                ...
                                <input type="number" id="thetichdungdich" name="b" placeholder="Nhập thể tích"
