    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card-style cardform">
                ...
                <form action="apsuat" method="post">
                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            <div class="col mb-4">
                                <label class="lb" for="somolchattan"> F</label>
                                <input type="number" id="somolchattan" name="a" placeholder="Nhập lực tác dụng vào vật"
                            ...
                            <div class="col mb-4">
                                <label class="lb" for="thetichdungdich">S</label>
                                <input type="number" id="thetichdungdich" name="b" placeholder="Nhập diện tích của vật"
