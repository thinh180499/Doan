                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            <div class="col mb-4">
                                ...
                                <input type="number" id="somolchattan" name="a" placeholder="Nhập công của lực tác dụng vào vật"
                            ...
                            <div class="col mb-4">
                                ...
                                <input type="number" id="thetichdungdich" name="b" placeholder="Nhập thời gian tác dụng"
