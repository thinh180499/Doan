...
@section('title', 'Tính khối lượng chất')
                ...
                <form action="khoiluongchat" method="post">
                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col mb-4">
                                <div class="input-style-1">
                                    <label for="khoiluongmol">M</label>
                                    <input type="number" id="khoiluongmol" name="b" placeholder="Nhập khối lượng mol"
                                        class="input" step="any"
