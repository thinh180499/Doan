...
@section('title', 'Tính nồng độ mol theo số mol')

@section('content')
    <div class="row mt-4">
        <div class="col-lg-7 tinhtoan">
            <div class="card-style cardform h-100">
                <h2>Tính nồng độ mol theo số mol:</h2>
                        ...
                        <div class="row d-flex flex-column">
                            <div class="col">
                                <div class="input-style-1">
                                    <label for="somolchattan"> n<sub>ct</sub></label>
                                    <input type="number" id="somolchattan" name="a"
                                        placeholder="Nhập số mol chất tan" class="input" step="any"
                            ...
                            <div class="col mb-4">
                                <div class="input-style-1">
                                    ...
                                    <input type="number" id="thetichdungdich" name="b"
                                        ...
                                        value="{{ old('b') }} {{ isset($b) && is_numeric($b) ? $b : old('b') }}" />
                                </div>
                            </div>
