    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card-style cardform">
                <h2>diện tích xung quanh hình hộp chữ nhật:</h2>
                @if ($errors->any())
                <h2 style="color: red;">
                ...
                <form action="dientichxungquanghinhhopchunhat" method="post">
                    ...
                    <div class="container-fluid mt-4 mb-4">
                        <div class="row justify-content-center">
                            <div class="col-auto border rounded-lg p-3 d-flex align-items-center">
                                <div class="mr-5">
                                    <span>S<sub>xq</sub>=2*a*b*h</span>
                                </div>
                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            ...
                            <div class="col mb-4">
                                <label class="lb" for="thetichdungdich">cạnh h</label>
                                <input type="number" id="thetichdungdich" name="c" placeholder="Nhập cạnh cao h"
