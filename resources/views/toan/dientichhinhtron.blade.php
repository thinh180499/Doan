        ...
        <div class="col">
            <div class="card-style cardform">
                ...
                <h2 style="color: red;">
                 ...
                 @endif
                <form action="dientichhinhtron" method="post">
                    ...
                    <div class="container">
                        <div class="row d-flex flex-column">
                            <div class="col mb-4">
                                <label class="lb" for="somolchattan"> bán kính R</label>
                                <input type="number" id="somolchattan" name="a" placeholder="Nhập bán kính R"
